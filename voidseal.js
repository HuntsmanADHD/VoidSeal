'use strict';
// ============================================================================
// VoidSeal - ChaCha20-Poly1305 (RFC 8439) authenticated encryption.
//
// 100% pure JavaScript. No WebAssembly, no native bindings, no dependencies,
// no shipped binary. One self-contained file you can audit top to bottom.
//
//   const { seal, open } = require('./voidseal.js');           // Node
//   <script src="voidseal.js"></script> -> window.VoidSeal     // browser
//
//   seal(key32, nonce12, plaintext, aad?) -> { ciphertext, tag }
//   open(key32, nonce12, ciphertext, tag, aad?) -> plaintext | null  (null = tampered/bad key)
//
// Correctness is verified in test.js against the RFC 8439 vectors, Node's native
// OpenSSL, and an independent BigInt Poly1305 oracle.
// ============================================================================
...
const VoidSeal = { seal, open, chacha20, poly1305, poly1305KeyGen, toHex };
if (typeof module !== 'undefined' && module.exports) module.exports = VoidSeal;
if (typeof globalThis !== 'undefined') globalThis.VoidSeal = VoidSeal;
